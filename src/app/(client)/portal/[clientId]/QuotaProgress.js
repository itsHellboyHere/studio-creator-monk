...
const CONTENT_TYPE_LABELS = {
  REEL: "Reel", POST: "Post", STORY: "Story", VIDEO_LONG: "Long Video",
};
  ...
  return (
    <div className={styles.quotaProgress}>
      ...
      <div className={styles.qpMonthNav}>
        ...
        {/* Center message */}
        <div className={styles.qpMonthCenter}>
          <span className={styles.qpTitle}>{monthLabel} Deliverables</span>
          {isCurrentMonth && <span className={styles.qpCurrentBadge}>Current Month</span>}
        </div>
      ...
      {/* ── Summary Row ── */}
      <div className={styles.qpSummaryRow}>
        ...
        <div className={styles.qpBigCount}>
                ...
                return (
                  <div key={q.id} className={styles.qpTypeRow}>
                    <div className={styles.qpTypeLeft}>
                      <span className={styles.qpTypeLabel} style={{ background: pm.bg, color: pm.color }}>
                        {label}
                      </span>
                    ...
                    <div className={styles.qpTypeRight}>
                      ...
                      <span className={styles.qpFraction}>
                        {done}<span className={styles.qpFractionOf}>/{q.amount}</span>
                      </span>
                    </div>
                  </div>
                );
